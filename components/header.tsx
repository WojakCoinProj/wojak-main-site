    ...
    <header className="fixed top-0 left-0 right-0 z-50 bg-background/80 backdrop-blur-sm border-b border-border">
      <div className="container mx-auto px-4 py-3 flex items-center justify-between">
        <Link href="/" className="flex items-center gap-2 hover:opacity-80 transition-opacity">
          <Image src="/wojak-logo.png" alt="WojakCoin" width={40} height={40} className="rounded-full" />
          <span className="font-bold text-lg hidden sm:inline">WojakCoin</span>
        </Link>
        ...
        <div className="flex items-center gap-2">
          ...
          <Link href="https://v0-wojakdonations.vercel.app/" target="_blank" rel="noopener noreferrer">
